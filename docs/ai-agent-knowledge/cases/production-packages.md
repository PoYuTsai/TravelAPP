...
- For airport pickup/dropoff, allocate the normal passenger Vans first: 6–7 guests add no luggage Van; 8–9 add one; 10–14 split across two passenger Vans and add none; 15–18 add one. The luggage Van is THB 500 per trip; each passenger Van remains THB 700 per trip. Groups of 19+ are manual.
- Customer-requested comfort upgrades are internal manual exceptions and must be confirmed with Eric before the formal quote. For 2–3 guests requesting a Van, use the matching Tier/guide option's 4-person row multiplied by 4 as the minimum charter charge. For 9 guests requesting two passenger Vans, use the matching 10-person row multiplied by 10 as the minimum charter charge. Actual-person add-ons remain based on actual travelers; airport-only transfers are THB 700 for one Van or THB 1,400 for two, and a 9-person group split across two Vans adds no luggage Van. Driver lodging follows the actual vehicle count. Do not publish these upgrade formulas or promise a free upgrade.
