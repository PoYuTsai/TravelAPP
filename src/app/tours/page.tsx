...
export const metadata: Metadata = {
  title: '清邁親子行程案例｜深受台灣家庭信賴｜清微旅行',
  description: '爸媽開的清邁親子包車行程案例。夜間動物園、大象互動、清萊一日遊⋯查看清微旅行的招牌套餐和客製化行程範例。',
  alternates: {
    canonical: 'https://chiangway-travel.com/tours',
  },
  openGraph: {
    title: '清邁親子行程案例｜深受台灣家庭信賴｜清微旅行',
    description: '爸媽開的清邁親子包車行程案例。查看清微旅行的招牌套餐和客製化行程範例。',
  ...
  twitter: {
    ...
    title: '清邁親子行程案例｜清微旅行',
    description: '爸媽開的清邁親子包車行程案例，深受台灣家庭信賴。',
