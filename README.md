...
| 定價 2026-07 | 官網僅公開三個熱門套餐每人參考起價；完整「人數 × 地區 × 導遊」矩陣保留內部核價 | ✅ 完成 |
| 套餐 2026-07 | 三個公開套餐報價沿用原網址，已同步新版人頭價、包含／不含與配車後固定行李車規則（500／趟） | ✅ 完成 |
...
- 包車 / 民宿 / About Us 頁面；包車頁公開三個熱門套餐的每人參考起價，完整人數、地區與導遊價目僅供內部核價，親子詢價提供正式全家總價
- 歷史案例展示（狀態排序、年份分組、分頁載入）
- 品牌實體訊號集中於 `src/lib/brand-entity.ts`

### 內部營運工具（位於 `/studio`）
- **Sanity Studio** — 內容管理 + 工具入口
- **報價計算器（正式版）** — 智慧行程解析、多飯店房型、門票互斥群組、泰服體驗、三階段付款、超時計算、共享案例同步；更新既有案例會顯示明確目標並以 Sanity revision 防止多人互蓋
